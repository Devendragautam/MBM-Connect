    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden bg-dark-900">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8 animate-fadeInUp">
          ...
          <p className="text-dark-400">Sign in to your MBM Connect account</p>
        </div>
        ...
        <div className="glass-panel p-8 animate-slideUp">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="group animate-fadeInUp" style={{ animationDelay: '0.15s' }}>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg border-2 transition-all pl-11 font-medium bg-dark-800/50 border-dark-700 text-white focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 focus:outline-none placeholder-dark-500"
                  placeholder="you@example.com"
                  required
                />
                <svg className="absolute left-3 top-3.5 w-5 h-5 transition-colors text-dark-400 group-focus-within:text-primary-500" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="group animate-fadeInUp" style={{ animationDelay: '0.25s' }}>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-3.5 transition-colors text-dark-400 hover:text-dark-200"
                >
                  {showPassword ? (
            ...
            <div className="flex justify-end animate-fadeInUp" style={{ animationDelay: '0.35s' }}>
              <Link to="/forgot-password" className="text-sm font-medium transition-colors text-primary-400 hover:text-primary-300">
                Forgot password?
              </Link>
            </div>
            ...
            <div className="relative my-6 animate-fadeInUp" style={{ animationDelay: '0.55s' }}>
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-dark-800 text-dark-400">Don't have an account?</span>
              </div>
            </div>
        ...
        {/* Footer text */}
        <p className="text-center text-sm mt-6 animate-fadeInUp text-dark-400" style={{ animationDelay: '0.75s' }}>

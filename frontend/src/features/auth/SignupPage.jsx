...
const SignupPage = () => {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center px-4 py-8 ${isDarkMode ? 'bg-secondary-900' : 'bg-gradient-to-br from-primary-50 via-white to-blue-50'}`}>
      ...
      <div className="relative w-full max-w-2xl">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className={isDarkMode ? 'text-gray-400' : 'text-secondary-600'}>Create your account and start connecting</p>
        </div>
        ...
        <div className={`rounded-2xl shadow-xl-light backdrop-blur-xl p-8 animate-slide-up ${isDarkMode ? 'bg-secondary-800' : 'bg-white'}`}>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* Avatar Upload */}
            <div className="group">
              <label className={`block text-sm font-semibold mb-3 ${isDarkMode ? 'text-gray-300' : 'text-secondary-700'}`}>
                Profile Avatar
              </label>
              <label className={`relative flex flex-col items-center justify-center w-full p-6 border-2 border-dashed rounded-xl cursor-pointer transition-colors group-focus-within:border-primary-500 ${
                isDarkMode 
                ...
                {avatarPreview ? (
                  ...
                  <>
                    <svg className={`w-8 h-8 mb-2 ${isDarkMode ? 'text-gray-400' : 'text-secondary-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                    </svg>
                    <p className={`text-sm font-medium ${isDarkMode ? 'text-gray-300' : 'text-secondary-700'}`}>Click to upload or drag and drop</p>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className={`px-2 ${isDarkMode ? 'bg-secondary-800 text-gray-400' : 'bg-white text-secondary-500'}`}>Already have an account?</span>
              </div>
            </div>
